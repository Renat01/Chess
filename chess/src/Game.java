    ...
    //Method for making the actions when a button is clicked 
        ...
        public void makeMove(JButton sourcebutton, int x, int y){
            ...
            if(possiblemoves.contains(sourcebutton)){
                ...
                //System.out.println(new FenString().createFEN(board, timer1.isRunning(), castlingrights, fiftymoverule, fenmovecounter, passantstring()));
            }
        }
        ...
        private boolean checkCastleLong(){
            ...
            if(timer1.isRunning() && !KingInCheck(board) && board[7][0].isRook){
